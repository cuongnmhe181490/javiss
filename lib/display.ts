...
const recipeTranslations = {
  "breakfast-overnight-oats": {
    ...
    instructions: [
      "Cho yến mạch, sữa chua, sữa tươi và hạt chia vào hũ hoặc tô sâu.",
      "Khuấy đều đến khi hỗn hợp sánh nhẹ, không còn vón ở đáy.",
      "Đậy kín và để trong ngăn mát ít nhất 6 giờ hoặc qua đêm.",
      "Khi ăn, đảo lại một lần rồi thêm quả mọng lên trên cho tươi vị.",
      "Nếu muốn mềm hơn, thêm 1 đến 2 muỗng sữa trước khi dùng.",
    ],
  },
  "breakfast-omelet-toast": {
    ...
    instructions: [
      "Đập trứng ra bát, thêm chút muối tiêu rồi đánh đều.",
      "Làm nóng chảo, cho rau chân vịt vào đảo nhanh đến khi xẹp nhẹ.",
      "Đổ trứng vào chảo, rắc feta lên trên và hạ lửa vừa.",
      "Gập trứng lại khi mặt trên vừa se, tránh nấu quá khô.",
      "Dùng nóng cùng bánh mì nướng để đủ no hơn.",
    ],
  },
  "breakfast-smoothie-bowl": {
    ...
    instructions: [
      "Cho chuối, sữa chua, sữa và bột protein vào máy xay.",
      "Xay đến khi hỗn hợp mịn, sánh và đủ đặc để ăn bằng muỗng.",
      "Đổ ra bát, dàn đều mặt cho đẹp.",
      "Rưới bơ đậu phộng lên trên và xoáy nhẹ để tạo vị đậm hơn.",
      "Ăn ngay khi còn lạnh để giữ độ tươi.",
    ],
  },
  "lunch-chicken-rice-bowl": {
    ...
    instructions: [
      "Vo gạo và nấu cơm trước để kịp chuẩn bị phần còn lại.",
      "Ướp ức gà với chút muối tiêu rồi áp chảo đến khi chín vàng hai mặt.",
      "Thái dưa leo, cà chua và để riêng cho ráo nước.",
      "Trộn sữa chua với nước cốt chanh và chút muối để làm sốt nhẹ.",
      "Cho cơm ra bát, xếp gà và rau lên trên rồi rưới sốt khi ăn.",
    ],
  },
  "lunch-tuna-salad": {
    ...
    instructions: [
      "Để ráo cá ngừ và đậu gà trước khi trộn để salad không bị ướt.",
      "Cho rau xanh, dưa leo, đậu gà và cá ngừ vào tô lớn.",
      "Rưới dầu ô liu và nước cốt chanh lên mặt salad.",
      "Trộn nhẹ tay để giữ nguyên độ giòn của rau.",
      "Dùng ngay sau khi trộn để vị tươi và không bị mềm.",
    ],
  },
  "lunch-lentil-soup": {
    ...
    instructions: [
      "Phi thơm hành tây và cà rốt với ít dầu đến khi dậy mùi ngọt.",
      "Cho cà chua vào đảo cùng để tạo nền vị đậm hơn.",
      "Thêm đậu lăng và nước dùng rau củ, đun sôi rồi hạ lửa vừa.",
      "Nấu đến khi đậu mềm và nước súp hơi sánh lại.",
      "Nêm vừa miệng, vắt chút chanh nếu thích rồi dùng nóng.",
    ],
  },
  "dinner-salmon-rice": {
    ...
    instructions: [
      "Nấu cơm và hấp bông cải trước để mọi phần chín cùng lúc.",
      "Thấm khô cá hồi rồi áp chảo mặt da xuống trước để cá vàng đẹp.",
      "Lật cá khi mặt dưới đã giòn, nấu đến khi phần giữa vừa chín.",
      "Bày cơm, bông cải và cá hồi ra đĩa theo từng phần rõ ràng.",
      "Vắt thêm chanh lên cá ngay trước khi ăn để vị sáng và dễ ăn hơn.",
    ],
  },
  "dinner-tofu-fried-rice": {
    ...
    instructions: [
      "Dùng cơm nguội để hạt cơm tơi và không bị nát khi rang.",
      "Áp chảo đậu phụ trước đến khi mặt ngoài vàng nhẹ rồi gắp ra.",
      "Xào cà rốt, đậu Hà Lan hoặc rau củ có sẵn trong chảo nóng.",
      "Cho cơm vào đảo đều tay, nêm nước tương vừa miệng.",
      "Trả đậu phụ lại chảo ở cuối cùng, đảo nhanh rồi dùng ngay.",
    ],
  },
  "dinner-chickpea-curry": {
    ...
    instructions: [
      "Phi hành với gia vị khô trên lửa vừa đến khi dậy mùi.",
      "Cho cà chua vào nấu trước để tạo phần sốt nền.",
      "Thêm đậu gà và nước cốt dừa, khuấy đều cho hòa quyện.",
      "Nấu liu riu đến khi sốt sánh lại và đậu ngấm vị.",
      "Ăn cùng cơm nóng, có thể thêm rau thơm nếu muốn dễ ăn hơn.",
    ],
  },
  "snack-apple-pb": {
    ...
    instructions: [
      "Rửa sạch táo và cắt thành lát vừa ăn.",
