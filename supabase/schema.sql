...
create table if not exists public.profiles (
  ...
  max_cooking_time_min integer not null default 30 check (max_cooking_time_min between 5 and 180),
...
create table if not exists public.settings (
  ...
  budget_mode_default text not null default 'weekly',
  measurement_system text not null default 'metric',
  region text not null default 'vi-VN',
